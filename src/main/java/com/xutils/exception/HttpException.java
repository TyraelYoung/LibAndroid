...
public class HttpException extends BaseException {
    ...
    private String investExceptionCode;

    public void setInvestExceptionCode(String exceptionCode){
        investExceptionCode = exceptionCode;
    }

    public String getInvestExceptionCode(){
        return investExceptionCode;
    }
