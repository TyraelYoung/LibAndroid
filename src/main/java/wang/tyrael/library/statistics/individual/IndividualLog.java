...
import wang.tyrael.android.PreferenceHelper;
import wang.tyrael.json.individual.User;
...
public class IndividualLog {
    ...
    private BlockingDeque<Logable> mEventQueue = new LinkedBlockingDeque<Logable>();
